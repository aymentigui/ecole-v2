...
export function Footer() {
  ...
  useEffect(()=>{
    getAboutSettings().then((data)=>setAbout(p=>(data.siteDescription??`Créé en 2022 sous la dénomination Groupement Formactive Center, notre collectif s'est fixé comme ambition principale de favoriser la formation continue. Avec une approche novatrice centrée sur les entreprises et les individus, de développement personnel et professionnel`)))
